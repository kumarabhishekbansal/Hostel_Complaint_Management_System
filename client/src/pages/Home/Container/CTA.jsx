      ...
      <section className="relative bg-dark-hard px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
              <Typewriter texts={"Weelcome to our mission!" }/>
            ...
            <div className="w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0">
              ...
              <h2 className="text-xl md:text-2xl text-slate-400 hover:text-orange-300 ">
                We believe that every student deserves an environment where they
                can focus on their studies without unnecessary stress and
                distractions. We're committed to creating that environment for
                you.
              </h2>
            </div>
            ...
            <div className="w-3/4 mx-auto relative">
              ...
              <div className="w-full rounded-xl bg-white p-3 z-[1] relative">
                <img
                  src={images.CTA}
                  alt="title"
                  className="w-full object-cover object-center h-auto md:h-50 lg:h-48 xl:h-60"
                />
                <div className="p-5">
                  ...
                  <p className="text-dark-light mt-3 text-sm md:text-lg">
                    Hostel life should be about learning, growing, and building
                    lasting friendships
                  </p>
                </div>
              </div>
