...
import { getProfile, updateStudentProfile } from "../../../services/user";
...
import {
  passwordvalidate,
  matchPassword,
} from "../../../helper/validations/PasswordValidate";
import { emailvalidate } from "../../../helper/validations/EmailValidation";
import { BsFillPersonFill, BsRecordCircle, BsVoicemail } from "react-icons/bs";
import {
  MdAddCard,
  MdDateRange,
  MdEmail,
        ...
        <div className="flex flex-col md:flex-row gap-y-5 md:gap-x-5 md:justify-around m-5">
          ...
          <div className="flex flex-col  w-full md:w-1/2">
            ...
            />
             ...
             <ValueInputForms
              children={<MdStairs />}
              value={userstate && "FloorNo :  " +  userstate?.userInfo?.floorNo}
              type={"text"}
            />

            {/* Department */}
            <ValueInputForms
              children={<MdLocalFireDepartment />}
              value={userstate && "Department :  " +  userstate?.userInfo?.department}
              type={"text"}
            />
            ...
            <ValueInputForms
              children={<MdHouse />}
              value={userstate && "Hostel :  " +  userstate?.userInfo?.hostel_name}
              type={"text"}
            />
              ...
              <ValueInputForms
              children={<MdRoom />}
              value={userstate && "Room No.   " + userstate?.userInfo?.roomNo}
              type={"text"}
            />
